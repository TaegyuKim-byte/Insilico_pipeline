...
def create_dataset(file) -> DatasetUploadResponse:
    # 파일 형식 검증
    ...
    # 파일 저장 (크기 제한 체크)
    file_path = settings.storage_dir / f"{dataset_id}.h5ad"
    temporary_path = settings.storage_dir / f"{dataset_id}.h5ad.part"
    ...
    try:
        ...
        try:
            ...
            has_graph = "neighbors" in adata.uns
