    ...
    <div className="card elev-sm" style={{ width: 500, padding: "var(--space-8)" }}>
      {phase === "idle" && (
        <>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="#0000000" viewBox="0 0 256 256">
            ...
            <button
              ...
              style={{ marginTop: "var(--space-1)", background: "transparent", color: "var(--color--accent)" }}
